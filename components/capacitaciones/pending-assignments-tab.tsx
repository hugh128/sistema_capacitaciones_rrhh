...
import { Calendar, Users, Search, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Loader2 } from "lucide-react"
      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-16 text-muted-foreground">
            ...
            <p className="text-lg font-medium">Cargando capacitaciones...</p>
            <p className="text-sm mt-1">Por favor espera un momento</p>
          </div>
        </CardContent>
      </Card>
    )
